...
<div class="container">
    <div class="row medium-padding120">
        <main class="main">
            <div class="col-lg-10 col-lg-offset-1">
                <article class="hentry post post-standard-details">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post-additional-info">
                            ...
                            <span class="category">
                                ...
                                <a href="{{ route('categories.single' , ['id' => $post->category->id]) }}">{{ $post->category->name }}</a>
                            </span>
                    ...
                    <div class="socials text-center">
                            <div class="addthis_inline_share_toolbox_y998"></div> 
                    </div>
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb">
                        <img src="{{ asset( $post->user->profile->avatar) }}" class="rounded rounded-circle" width="50px" height="50px"  alt="Author">
                    </div>
                ...
                <div class="pagination-arrow">
                    ...
                    @if($prev)
                    <a href="{{ route('posts.single' ,['slug' => $prev->slug]) }}" class="btn-prev-wrap">
                            <svg class="btn-prev">
                                <use xlink:href="#"></use>
                            </svg>
            ...
            <div class="col-lg-12">
                <aside aria-label="sidebar" class="sidebar sidebar-right text-center">
                    <div  class="widget w-tags">
                        <div class="heading text-center">
